...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_stdmain_ada2012_ch01" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#5d5a20e9#;
   pragma Export (C, u00001, "stdmain_ada2012_ch01B");
